...
class BlogApiControllerTest {
    ...
    @Test
    @DisplayName("아티클 추가할 때 title이 null이면 실패")
    ...
    @Test
    @DisplayName("아티클 추가할 때 title이 10자를 넘으면 실패")
    public void addArticleSizeValidation() throws Exception {
        //given
        final String url = "/api/articles";
        final String title = "12345678912";
        final String content = "content";
        final AddArticleRequest userRequest = new AddArticleRequest(title, content);
    ...
    @Test
    @DisplayName("잘못된 HTTP 메서드로 아티클을 조회 시 실패")
    ...
    @Test
    @DisplayName("존재하지 않는 아티클을 조회 시 실패")
