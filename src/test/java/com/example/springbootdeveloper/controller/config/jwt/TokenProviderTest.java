package com.example.springbootdeveloper.controller.config.jwt;
...
class TokenProviderTest {
    ...
    @DisplayName("generateToken(): 유저 정보와 만료 기간을 전달해 토큰 발급")
    @Test
    void generateToken() {
        // given
    ...
    @DisplayName("validToken(): 만료된 토큰인 경우 유효성 검증 실패")
    @Test
    ...
    @DisplayName("getAuthentication(): 토큰 기반으로 인증정보 가져오기")
    @Test
